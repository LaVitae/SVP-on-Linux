...
RPMFUSION_LINK="https://download1.rpmfusion.org/free/fedora/releases/42/Everything/x86_64/os/Packages/r/rpmfusion-free-release-42-1.noarch.rpm"
RPMFUSION_FILENAME="rpmfusion-free-release-42-1.noarch.rpm"
ZIMG_LINK="--branch release-3.0.5 https://github.com/sekrit-twc/zimg.git"
VAPOURSYNTH_LINK="--branch R71 https://github.com/vapoursynth/vapoursynth.git "
